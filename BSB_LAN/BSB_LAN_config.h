...
char wifi_ssid[32] = "wifi_gui"; // enter your WiFi network name (SSID) here
char wifi_pass[64] = "guillaume";// enter your WiFi password here
...
char mqtt_broker_addr[33] = "192.168.1.104:1883";    // MQTT broker. Adjust LoggingMode to activate. Can be IP address or hostname. Optional port can be specified after trailing colon. If omitted, port defaults to 1883.
char MQTTUsername[65] = "guillaume";                 // Set username for MQTT broker here or set empty string if no username/password is used.
char MQTTPassword[65] = "guillaume";                 // Set password for MQTT broker here or set empty string if no password is used.
